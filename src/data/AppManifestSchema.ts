import { PublicationMetadataMainFocusType } from "@digiv3rse/client";
import { z } from "zod";
...
const ProfileUrlSchema = z.object(
  {
    url: z
      .string({
        description:
          "The `:handle` placeholder will be replaced with the profile's full handle, including namespace (e.g. `namespace/digiapi`, `namespace/digiprotocol`).",
      })
      .url()
      .includes(":handle"),
  },
